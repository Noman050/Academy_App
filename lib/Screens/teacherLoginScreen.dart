...
import 'package:student_teacher_app/Screens/teacherContinueScreen.dart';


class TeacherLoginScreen extends StatefulWidget {
  const TeacherLoginScreen({Key? key, this.uid, this.name
  }) :super(key: key);
  final uid;
  final name;
  @override
                            ...
                            SizedBox(
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed:(){
                                    ...
                                    Navigator.push(context,
                                        MaterialPageRoute(builder: (context) => TeacherContinueScreen(uid:uid,name:name,password: password.text)));
                                  },
                                )
                            ),
